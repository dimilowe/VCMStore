...
const toolIcons: Record<string, { icon: React.ComponentType<{ className?: string }>; bg: string }> = {
  ...
  "facebook-thumbnail-analyzer": { icon: Target, bg: "bg-blue-600" },
  "instagram-bio-analyzer": { icon: Instagram, bg: "bg-gradient-to-br from-purple-500 to-pink-500" },
  ...
  "linkedin-bio-analyzer": { icon: Linkedin, bg: "bg-blue-700" },
  "linkedin-cta-analyzer": { icon: Linkedin, bg: "bg-blue-600" },
  "linkedin-caption-analyzer": { icon: Linkedin, bg: "bg-sky-600" },
  "linkedin-hashtags-analyzer": { icon: Linkedin, bg: "bg-cyan-600" },
  "linkedin-hook-analyzer": { icon: Linkedin, bg: "bg-teal-600" },
  "tiktok-cta-analyzer": { icon: Video, bg: "bg-black" },
  "tiktok-caption-analyzer": { icon: Video, bg: "bg-gray-800" },
  "tiktok-hashtags-analyzer": { icon: Video, bg: "bg-pink-600" },
  "tiktok-hook-analyzer": { icon: Video, bg: "bg-cyan-500" },
  "tiktok-thumbnail-analyzer": { icon: Video, bg: "bg-red-600" },
  "twitter-bio-analyzer": { icon: Twitter, bg: "bg-sky-500" },
  "twitter-cta-analyzer": { icon: Twitter, bg: "bg-blue-500" },
  "twitter-caption-analyzer": { icon: Twitter, bg: "bg-sky-600" },
};

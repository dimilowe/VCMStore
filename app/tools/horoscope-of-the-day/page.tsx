      ...
      <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-700 px-4 py-1.5 rounded-full text-sm font-medium mb-4">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2">
                {ZODIAC_SIGNS.map((sign) => (
                  ...
                  >
                    ...
                    <div className="text-xs font-medium text-stone-700">{sign.name}</div>
                    <div className="text-[10px] text-stone-400">{sign.dates}</div>
                    {selectedSign === sign.name.toLowerCase() && (
          ...
          {horoscope && lastReading && (
            <div className="bg-gradient-to-br from-stone-900 to-stone-800 rounded-2xl shadow-xl p-6 md:p-8 mb-8 relative overflow-hidden">
          ...
          <div className="space-y-12 mt-16">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600 font-bold mb-3">1</div>
                  <h3 className="font-semibold text-stone-800 mb-2">Choose Your Sign</h3>
                  <p className="text-sm text-stone-600">Select your zodiac sign from the 12 options. Not sure? Pick based on your birthday.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600 font-bold mb-3">2</div>
                  <h3 className="font-semibold text-stone-800 mb-2">Pick Your Tone</h3>
                  <p className="text-sm text-stone-600">Want encouragement? Go Sweet. Need a reality check? Choose Brutal. Feeling playful? Sassy's your vibe.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600 font-bold mb-3">3</div>
                  <h3 className="font-semibold text-stone-800 mb-2">Get Your Reading</h3>
                  <p className="text-sm text-stone-600">Our AI generates a unique horoscope of the day for your sign + tone. It stays the same all day so everyone gets the same cosmic energy.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <Sun className="w-5 h-5 text-yellow-500 mt-0.5 shrink-0" />
                  <div>
                    <strong className="text-stone-800">Reflection & Self-Awareness</strong>
                    <p className="text-stone-600 text-sm">Daily horoscopes create a moment to pause and check in with yourself.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Sparkles className="w-5 h-5 text-yellow-500 mt-0.5 shrink-0" />
                  <div>
                    <strong className="text-stone-800">Entertainment Value</strong>
                    <p className="text-stone-600 text-sm">Let's be honest – they're fun. Especially when they're brutally honest.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Moon className="w-5 h-5 text-yellow-500 mt-0.5 shrink-0" />
                  <div>
                    <strong className="text-stone-800">Daily Ritual</strong>
                    <p className="text-stone-600 text-sm">Checking your horoscope of the day becomes a grounding morning routine.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <Star className="w-5 h-5 text-yellow-500 mt-0.5 shrink-0" />
                  <div>
                    <strong className="text-stone-800">Conversation Starter</strong>
                    <p className="text-stone-600 text-sm">Share your reading with friends and watch the chaos unfold.</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <h3 className="font-semibold text-stone-800 mb-2">Is this horoscope of the day accurate?</h3>
                  <p className="text-stone-600 text-sm">Our AI-generated horoscopes are designed for entertainment and self-reflection. They provide thought-provoking insights based on zodiac archetypes, but should be taken as fun guidance rather than literal predictions.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <h3 className="font-semibold text-stone-800 mb-2">How often does the horoscope of the day update?</h3>
                  <p className="text-stone-600 text-sm">Each unique combination of zodiac sign and tone generates a new horoscope once per day. The reading stays the same throughout the day, then refreshes at midnight UTC.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <h3 className="font-semibold text-stone-800 mb-2">Is this daily horoscope free?</h3>
                  <p className="text-stone-600 text-sm">Yes! Our horoscope of the day generator is completely free to use. No signup required, no limits on how many readings you can get.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <h3 className="font-semibold text-stone-800 mb-2">Can I get a new horoscope if I don't like today's?</h3>
                  <p className="text-stone-600 text-sm">The same sign + tone combination gives the same reading all day. Try a different tone (Sweet, Sassy, or Brutal) for a fresh perspective, or check back tomorrow for a new reading.</p>
                </div>
                <div className="bg-white rounded-xl p-5 border border-stone-200">
                  <h3 className="font-semibold text-stone-800 mb-2">What makes this horoscope of the day different?</h3>
                  <p className="text-stone-600 text-sm">Most daily horoscopes are generic and forgettable. Our Real AF horoscope uses AI to generate readings that are specific, memorable, and honest – sometimes brutally so. Plus, you choose your tone based on what kind of cosmic energy you need today.</p>
                </div>
              </div>
            </section>
          </div>

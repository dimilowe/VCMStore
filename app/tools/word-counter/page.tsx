      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-stone-200 p-6 md:p-8 mb-8">
          ...
          <textarea
            ...
            className="w-full min-h-[220px] p-4 border border-stone-300 rounded-xl resize-y focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all text-stone-900 placeholder-stone-400"
          />
          ...
          <div className="mt-6 p-4 bg-stone-50 rounded-xl border border-stone-100">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span className="text-sm font-medium text-stone-600">Reading Level</span>
        ...
        {keywords.length > 0 && (
          <div className="bg-white rounded-2xl shadow-lg border border-stone-200 p-6 md:p-8 mb-12">
            <h2 className="text-lg font-bold text-stone-900 mb-4">Keyword Density</h2>
            <p className="text-sm text-stone-500 mb-4">Top keywords by frequency (excluding common words)</p>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-stone-200">
                    <th className="text-left py-2 px-3 text-sm font-medium text-stone-600">Word</th>
                    <th className="text-center py-2 px-3 text-sm font-medium text-stone-600">Count</th>
                    <th className="text-right py-2 px-3 text-sm font-medium text-stone-600">Percentage</th>
                  </tr>
                </thead>
                <tbody>
                  {keywords.map((kw, index) => (
                    <tr key={kw.word} className={index % 2 === 0 ? 'bg-stone-50' : ''}>
                      <td className="py-2 px-3 text-stone-900 font-medium">{kw.word}</td>
                      <td className="py-2 px-3 text-center text-stone-600">{kw.count}</td>
                      <td className="py-2 px-3 text-right text-stone-600">{kw.percentage}%</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="bg-stone-900 rounded-2xl p-8 md:p-12 text-center mb-12">
          ...
          <Link
            href="/product/ape"
            className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-stone-900 font-semibold py-3 px-6 rounded-lg transition-all"
          >
            Learn About APE
        ...
        <article className="prose prose-stone max-w-none">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-stone-200">
              <FileText className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-stone-900">Meet Word Limits</h3>
                <p className="text-sm text-stone-600">Stay within assignment, submission, or publication limits for essays, articles, and applications.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-stone-200">
              <Type className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-stone-900">Optimize Social Posts</h3>
                <p className="text-sm text-stone-600">Keep Twitter/X posts under 280 characters, Instagram captions readable, and YouTube descriptions optimized.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-stone-200">
              <BookOpen className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-stone-900">Improve Readability</h3>
                <p className="text-sm text-stone-600">Use reading level analysis to ensure your content matches your target audience's comprehension level.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-4 bg-white rounded-lg border border-stone-200">
              <Clock className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-stone-900">Estimate Reading Time</h3>
                <p className="text-sm text-stone-600">Know how long your blog posts, scripts, or presentations will take to read or deliver.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="p-4 bg-white rounded-lg border border-stone-200">
              <h3 className="font-semibold text-stone-900 mb-1">Word Count</h3>
              <p className="text-sm text-stone-600">The total number of words in your text, separated by spaces. This is the most commonly requested metric for assignments and submissions.</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-stone-200">
              <h3 className="font-semibold text-stone-900 mb-1">Character Count</h3>
              <p className="text-sm text-stone-600">Total characters including spaces (useful for general length) and excluding spaces (often used for SMS limits and certain platforms).</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-stone-200">
              <h3 className="font-semibold text-stone-900 mb-1">Sentences & Paragraphs</h3>
              <p className="text-sm text-stone-600">Sentences are counted by periods, question marks, and exclamation points. Paragraphs are separated by blank lines.</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-stone-200">
              <h3 className="font-semibold text-stone-900 mb-1">Reading Time</h3>
              <p className="text-sm text-stone-600">Calculated at 200 words per minute, which is the average adult reading speed. Useful for blog posts, presentations, and video scripts.</p>
            </div>
            <div className="p-4 bg-white rounded-lg border border-stone-200">
              <h3 className="font-semibold text-stone-900 mb-1">Reading Level</h3>
              <p className="text-sm text-stone-600">Based on a simplified Flesch-Kincaid formula. "Easy" text uses short sentences and simple words. "Difficult" text uses longer sentences and complex vocabulary.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-stone-200 divide-y divide-stone-200 mb-8">
            <FAQItem 
